...
public class LiulangdongwuCollectionView extends LiulangdongwuCollectionEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 类型的值
		*/
		private String liulangdongwuCollectionValue;
	...
	public LiulangdongwuCollectionView() {

	}

	public LiulangdongwuCollectionView(LiulangdongwuCollectionEntity liulangdongwuCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, liulangdongwuCollectionEntity);
			...
			* 获取： 类型的值
			*/
			public String getLiulangdongwuCollectionValue() {
				return liulangdongwuCollectionValue;
			}
			/**
			* 设置： 类型的值
			*/
			public void setLiulangdongwuCollectionValue(String liulangdongwuCollectionValue) {
				this.liulangdongwuCollectionValue = liulangdongwuCollectionValue;
			}
