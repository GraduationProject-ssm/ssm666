...
public class LiulangdongwuEntity<T> implements Serializable {
    ...
    public String toString() {
        return "Liulangdongwu{" +
            ...
            ", liulangdongwuUuidNumber=" + liulangdongwuUuidNumber +
            ", liulangdongwuPhoto=" + liulangdongwuPhoto +
            ", liulangdongwuTypes=" + liulangdongwuTypes +
            ", liulangdongwuPinzhongTypes=" + liulangdongwuPinzhongTypes +
            ", liulangdongwuDidian=" + liulangdongwuDidian +
            ", liulangdongwuAge=" + liulangdongwuAge +
            ", liulangdongwuClicknum=" + liulangdongwuClicknum +
            ", jiuzhuTypes=" + jiuzhuTypes +
            ", jiankangTypes=" + jiankangTypes +
            ", jueyuTypes=" + jueyuTypes +
            ", yimiaoTypes=" + yimiaoTypes +
            ", liulangdongwuContent=" + liulangdongwuContent +
            ", lingyangTypes=" + lingyangTypes +
