...
public class LiulangdongwuLiuyanEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public LiulangdongwuLiuyanEntity() {

	}

	public LiulangdongwuLiuyanEntity(T t) {
		try {
     ...
     * 留言内容
     */
    @TableField(value = "liulangdongwu_liuyan_text")
    ...
    public String toString() {
        return "LiulangdongwuLiuyan{" +
            "id=" + id +
            ", liulangdongwuId=" + liulangdongwuId +
            ", yezhuId=" + yezhuId +
            ", liulangdongwuLiuyanText=" + liulangdongwuLiuyanText +
